...
const CartItem = ({ onContinueShopping }) => {
  ...
  const calculateTotalAmount = () => {
    ...
    return total.toFixed(2); // Using toFixed(2) for standard currency formatting
  };

  const handleContinueShopping = (e) => {
    // Calls the function passed from ProductList.jsx to hide the cart
  ...
  // Calculate total cost based on quantity for a specific item (Subtotal)
