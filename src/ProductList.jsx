...
function ProductList({ onHomeClick }) {
    ...
    // Get the cart items to check which plants are already added
    ...
    const calculateTotalQuantity = () => {
        // Sums up the quantity property of every item in the cart
        return cart.reduce((total, item) => total + item.quantity, 0);
    };

    // Helper to check if a plant is in the cart to disable the button
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <a href="#" onClick={handleCartClick} style={{ color: 'white', textDecoration: 'none', position: 'relative' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40" fill="white" viewBox="0 0 256 256">
                            <path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" fill="none" stroke="white" strokeWidth="2"></path>
                        </svg>
                        {/* Cart count badge */}
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button
                                            className={`product-button ${isPlantInCart(plant.name) ? 'added' : ''}`}
